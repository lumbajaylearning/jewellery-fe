        ...
        return (
            <main className="mx-auto w-full max-w-7xl px-5 py-12 sm:px-6 lg:px-8 lg:py-16">
                ...
                <section className="mt-8 grid gap-5 md:grid-cols-3">
                    ...
                    <div className="rounded border border-border bg-white p-6"><MapPin className="h-6 w-6 text-gold" /><h2 className="mt-5 font-heading text-2xl text-text-primary">Saved addresses</h2><p className="mt-2 text-sm leading-6 text-text-secondary">Address management will use Medusa customer addresses.</p><span className="mt-5 inline-block text-xs text-text-secondary">Coming in the next account step</span></div>
